...
public abstract class Item
{
  ...
  public static sealed override int PLAIN = 0;
  public static sealed override int HYPERLINK = 1;
  public static sealed override int LAYOUT_LEFT = 1;
  public static sealed override int LAYOUT_SHRINK = 1024;
  public static sealed override int LAYOUT_TOP = 16;
  public static sealed override int LAYOUT_2 = 16384;
  public static sealed override int BUTTON = 2;
  public static sealed override int LAYOUT_RIGHT = 2;
  public static sealed override int LAYOUT_EXPAND = 2048;
  public static sealed override int LAYOUT_NEWLINE_BEFORE = 256;
  public static sealed override int LAYOUT_CENTER = 3;
  public static sealed override int LAYOUT_BOTTOM = 32;
  public static sealed override int LAYOUT_VSHRINK = 4096;
  public static sealed override int LAYOUT_VCENTER = 48;
  public static sealed override int LAYOUT_NEWLINE_AFTER = 512;
  public static sealed override int LAYOUT_VEXPAND = 8192;
 ...
 * Qualified Name:     javax.microedition.lcdui.Item
